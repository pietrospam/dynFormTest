 ...
 */
export function resolveField(fieldName, config, context, resolvedContainers) {
    ...
    if (typeRule?.fields?.[fieldName]) {
        ...
        if (override.required !== undefined)
            resolved.required = override.required;
    }
    ...
    if (statusRule) {
        ...
        if (statusRule.$allFields) {
            ...
            if (globalOverride.required !== undefined)
                resolved.required = globalOverride.required;
        }
 ...
 */
export function resolveAllFields(config, context, resolvedContainers) {
    const resolved = {};
